...
<table>
    <tr>
        <td align="center" width="33%">
            <img src="Главный_экран.png" alt="Главный экран" />
            <br /> <strong>Главный экран</strong> <br />
            Основная карта с судами и маршрутами
        </td>
        <td align="center" width="33%"> <img src="Отображение_всплывающих_подсказок.png" alt="Всплывающие подсказки" />
            <br /> <strong>Всплывающие подсказки</strong> <br /> Информация о судне при наведении </td>
        <td align="center" width="33%"> <img src="Отображение_зон_риска.png" alt="Зоны риска" /> <br /> <strong>Зоны
                риска</strong> <br /> Отображение зон с высоким риском </td>
    </tr>
    <tr>
        <td align="center" width="33%"> <img src="Отображение_лотности_трафика.png" alt="Плотность трафика" /> <br />
            <strong>Плотность трафика</strong> <br /> Тепловая карта интенсивности движения </td>
        <td align="center" width="33%"> <img src="Отображение_морских_коридоров.png" alt="Морские коридоры" /> <br />
            <strong>Морские коридоры</strong> <br /> Основные маршруты судоходства </td>
        <td align="center" width="33%"> <img src="Пересчет_зон_риска.png" alt="Пересчёт зон риска" /> <br />
            <strong>Пересчёт зон риска</strong> <br /> Обновление зон после изменения параметров </td>
    </tr>
    <tr>
        <td align="center" width="33%"> <img src="Построение_маршрута_минимум_времени.png" alt="Маршрут по времени" />
            <br /> <strong>Маршрут (минимум времени)</strong> <br /> Оптимизация по времени в пути </td>
        <td align="center" width="33%"> <img src="Построение_маршрута_минимум_риска.png" alt="Маршрут по риску" />
            <br /> <strong>Маршрут (минимум риска)</strong> <br /> Оптимизация по безопасности </td>
        <td align="center" width="33%"> <img src="Фильтрация_ретроспективных_данных_по_дате.png"
                alt="Фильтрация по дате" /> <br /> <strong>Фильтрация по дате</strong> <br /> Выбор ретроспективного
            периода </td>
    </tr>
    <tr>
        <td align="center" width="33%"> <img src="Экран_авторизации.png" alt="Авторизация" /> <br />
            <strong>Авторизация</strong> <br /> Форма входа в систему </td>
        <td align="center" width="33%"> <img src="Экран_регистрация.png" alt="Регистрация" /> <br />
